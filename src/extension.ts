...
export function activate(context: vscode.ExtensionContext) {
	...
	const viewRegistration = vscode.window.registerWebviewViewProvider(ColorWheelViewProvider.viewType, provider);
	...
	const disposable = vscode.commands.registerCommand('color-wheel.open', async () => {
		...
		await vscode.commands.executeCommand(`${ColorWheelViewProvider.viewType}.focus`);
